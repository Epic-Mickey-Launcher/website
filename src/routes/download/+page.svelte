...
<main style="display:flex;justify-content:center;height:80vh;">
  <div>
    ...
    <p></p>
    <button on:click={() => window.open(download_url)} class="downloadButton"
      >Download Latest Version ({tag_name} {stability})</button
    >
    <p></p>
    <button
      on:click={() =>
      ...
      class="downloadButton">Other Releases</button
    >
  </div>
</main>
